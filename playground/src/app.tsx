...
import * as markdown from '@ptdgrp/markdown-wasm';
import type { ParserOptions } from '@ptdgrp/markdown-wasm';
...
function App() {
  ...
  const handleNodeClick = (start?: any, end?: any) => {
    ...
    const centeredScrollTop =
      targetScrollTop - viewportHeight / 2 + lineHeight / 2;
          ...
          <div class="mb-2 flex items-center justify-between">
            ...
            <button
              onClick={() => {
                const content =
                  viewMode() === 'ast'
                    ? JSON.stringify(astSignal(), null, 2)
                    : htmlSignal();
          ...
          <Show when={viewMode() === 'frontmatter'}>
            <div class="json-viewer-container flex-1 overflow-auto rounded-lg border border-gray-300 bg-gray-900 p-4">
              <Show
                when={
                  frontmatterSignal() &&
                  typeof frontmatterSignal() === 'object' &&
                  Object.keys(frontmatterSignal()).length > 0
                }
                fallback={
                  <div class="flex h-full items-center justify-center text-gray-500">
                    <div class="text-center">
                      ...
                      <p class="mt-1 text-xs text-gray-600">
                        Add YAML frontmatter at the top of your markdown
                      </p>
                    </div>
                  </div>
                }
